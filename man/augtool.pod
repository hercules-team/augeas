...
Load files accordig to the transforms in C</augeas/load>.

=item B<defvar> E<lt>NAMEE<gt> E<lt>EXPRE<gt>

Define the variable NAME to the result of evalutating EXPR. The variable
...
Define the variable NAME to the result of evalutating EXPR, which must be a
