module Opendkim =
   ...
   *)
  let stringkv = key /(ADSPAction|AuthservID|AutoRestartRate|BaseDirectory/ .
  ...
  let integerkv = key /(AutoRestartCount|ClockDrift|DNSTimeout/ . 
  ...
  let booleankv = key /(AddAllSignatureResults|ADSPNoSuchDomain/ .
