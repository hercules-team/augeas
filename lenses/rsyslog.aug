...
let config_object_param = [ key /[A-Za-z]+/ . Sep.equal . Quote.dquote . store /[^"]+/ .Quote.dquote . Sep.opt_space ]
let config_object = [ key /action|global|input|module|parser|timezone/ . Sep.lbracket . config_object_param+ . Sep.rbracket . Util.comment_or_eol ]
